...
class ImageProcessor:
    ...
    def save_points_to_csv(self, grid_points, nir_wavelength_range, mir_wavelength_range, output_file):
        with open(output_file, mode='w', newline='') as file:
            ...
            writer.writerow(["ID", "X", "Y", "Blue Wavelength (nm)", "Green Wavelength (nm)", "Red Wavelength (nm)"])
            ...
            for idx, point in enumerate(grid_points):
                ...
                writer.writerow([idx + 1, x, y, blue_wavelength, green_wavelength, red_wavelength])
